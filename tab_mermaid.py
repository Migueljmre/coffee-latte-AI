...
def generar_mermaid(prompt_text, image):
    ...
    if chat_history["first_message"] and image is None:
        ...
        return "⚠️ El primer mensaje debe incluir una imagen.", None
...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            imagen_generada = gr.Image(label="Diagrama generado", type="filepath")

    submit_btn.click(fn=generar_mermaid, inputs=[prompt_input, image_input], outputs=[respuesta_output, imagen_generada])
